...
<!-- creamos el camvas -->
<canvas id='canvas' style="background:url(../../Resource/img/cuerpo.png);border: 1px solid #CCC;" width="200" height="200" >
...
<script type="text/javascript">
    ...
    var servicio = document.getElementsByName(inputservicio); 
    ...
    function GuardarTrazado(){
      ...
      IdServicio.value=document.getElementsByName(IdServicio);
      document.forms[idForm].submit();
