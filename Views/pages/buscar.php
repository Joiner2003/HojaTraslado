                                    ...
                                    <?php if (isset($_GET['IdServicio'])){ ?>
                                        ...
                                        <?php if ($key != NULL){ ?>
                                            <tr>
                                                ...
                                                <td align="center" style="padding: 0;"> <a href="info_traslado.php?IdServicio=<?= $key->__GET('IdServicio') ?>" title="Imprimir" class="btn btn-primary" target="_blank"><i class="fa fa-print"></i></a></td>
                                            </tr>
                                        <?php } ?>
                                    <?php }else{ ?>
