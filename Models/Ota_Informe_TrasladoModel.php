...
require_once('../../Models/Conexion/Conexion.php');
	...
	*/
	class Ota_Informe_TrasladoModel
	{
		...
		{
			try {
				$sql = ("INSERT INTO Ota_Informe_Traslado (Fecha1, Ficha, Pte_NumDoc, Pte_TipoDoc, Pte_FechaNac, Pte_Edad,Entidad,Pte_Regimen,Pte_Sexo, Pte_Telefono,Pte_Direccion,Pte_Ap1, Pte_Ap2, PteNom1, Pte_Nom2, Aco_Nombres, Aco_Apellidos, Aco_Documento, Aco_Perentezco, Sv_Origen, Sv_Origen1, Sv_Origen2, Sv_Origen3, Sv_Llegada, Sv_Llegada1, Sv_Llegada2, Sv_Llegada3, Sv_Salida, Sv_Salida1, Sv_Salida2, Sv_Salida3, Sv_Complejidad, Sv_TipoServicio, Sv_ExamenSolicitado) VALUES ( ?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)");
