...
spl_autoload_register(function($nombreClase)
{
	...
	**/
	class HomeController
	{
		...
		{
			$model = new Ota_Informe_TrasladoModel();
			$var = $model->AgregarEstPac($IdServicio, $Ef_Ta, $Ef_Fr, $Ef_Temp, $Ef_Glasgow, $Ef_Dx1, $Ef_Dx2, $Ef_HallazgoPos1, $Ef_Antecedentes1, $Ef_Gin1, $Ef_Gin2, $Ef_Gin3, $Ef_Gin4, $Ef_Gin5,  $Conven_1,$Conven_2,$Conven_3,$Conven_4,$Conven_5,$Conven_6,$Obs_conv );
			return $var;
		}
